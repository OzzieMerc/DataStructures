/*
	...
	DESCRIPTION: Tests the interface of the Doubly-Linked Lsit and also demonstrates how the data
	...
	void TestDoublyLinkedList()
	{
		Test("DoublyLinkedList")
		{
			...
			Subtest("AddHead()")
			{
				...
				unsigned int i = 0;
				for (DoublyLinkedList<int>::Node* iter = list.PeekHead(); iter; iter = iter->Next())
			...
			Subtest("Insert()")
			{
				...
				// Check that all numbers are in the list in the reverse order.
				unsigned int i = 0;
				for (DoublyLinkedList<int>::Node* iter = list1.PeekHead(); iter; iter = iter->Next())
					Require(iter->Data() == numbers[NUM_COUNT - 1 - i++]);
				...
				for (unsigned int i = 0; i < NUM_COUNT; ++i)
				{
					...
					DoublyLinkedList<int>::Node* iter = list2.PeekHead();
				...
				i = 0;
				for (DoublyLinkedList<int>::Node* iter = list2.PeekHead(); iter; iter = iter->Next())
				...
				i = 0;
				for (DoublyLinkedList<int>::Node* iter = list3.PeekHead(); iter; iter = iter->Next())
